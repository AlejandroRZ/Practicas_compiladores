...
parserAux (Seq:xs) (Q 4:Q 0:ys) (T Skip:ws) = parserAux (Seq:xs) (Q 2:Q 0:ys) (PC:ws)
parserAux [] (Q 4:Q 0:ys) (T Skip:ws) = parserAux [] (Q 2:Q 0:ys) (PC:ws)

parserAux [] (Q 7:Q 5:Q 2:Q 0:ys) (PC: T Seq: C:ws) = parserAux [] (Q 1:Q 0:ys) (C:ws)
parserAux (Seq:xs) (Q 8:Q 6:Q 3:Q 0:ys) (T (Loc num):T Assign:E:ws) = parserAux (Seq:xs) (Q 2:Q 0:ys) (PC:ws)
parserAux [] (Q 8:Q 6:Q 3:Q 0:ys) (T (Loc num):T Assign:E:ws) = parserAux [] (Q 2:Q 0:ys) (PC:ws)

parserAux (Seq:xs) (Q 9:Q 6:ys) (PE:ws) = parserAux (Seq:xs) (Q 8:Q 6:ys) (E:ws)
parserAux [] (Q 9:Q 6:ys) (PE:ws) =parserAux [] (Q 8:Q 6:ys) (E:ws)
parserAux (Seq:xs) (Q 10:Q 6:ys) (T (Loc num):ws) = parserAux (Seq:xs) (Q 9:Q 6:ys) (PE:ws)

parserAux (Sum:xs) (Q 10:Q 6:ys) (T (Loc num):ws) = parserAux (Sum:xs) (Q 9:Q 6:ys) (PE:ws)
parserAux [] (Q 10:Q 6:ys) (T (Loc num):ws) = parserAux [] (Q 9:Q 6:ys) (PE:ws)
...
parserAux [] (Q 11:Q 6:ys) (T (Number n):ws) = parserAux [] (Q 9:Q 6:ys) (PE:ws)

parserAux (Seq:xs) (Q 13:Q 12:Q 9:Q 6:ys) (PE:T Sum:E:ws) = parserAux (Seq:xs) (Q 8:Q 6:ys) (E:ws)
parserAux (Seq:xs) (Q 13:Q 12:Q 9:Q 12:ys) (PE:T Sum:E:ws) = parserAux (Seq:xs) (Q 13:Q 12:ys) (E:ws)
parserAux [] (Q 13:Q 12:Q 9:Q 6:ys) (PE:T Sum:E:ws) = parserAux [] (Q 8:Q 6:ys) (E:ws)
parserAux [] (Q 13:Q 12:Q 9:Q 12:ys) (PE:T Sum:E:ws) = parserAux [] (Q 13:Q 12:ys) (E:ws)
